...
Parameters ro(f)  correlation matrix betwee barley and the other securities
       /barley    1
        oats      0.93
        sesame    0.9
        grnd-meal 0.92/;
...
tails(s)..   mu=g=sum(f, a(f,s)*x(f));


models chance chance model        /all/

solve chance minimizing mu using lp;

display x.l, cost.l, mu.l;
