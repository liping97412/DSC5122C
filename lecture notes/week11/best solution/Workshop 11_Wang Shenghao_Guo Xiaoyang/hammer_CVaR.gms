...
Scalars mean      mean demand                                  /3192/
        ...
        v         salvage value                                /90/
        beta      probability of not in the tail               /0.99999/;
...
*Display cvar.l, exp_sales, exp_lost_sales, exp_leftover, stockout_prob;


********************************************************************************
***** Display Results in Text Files ********************************************
********************************************************************************
file results /hammer_cvar_s1000_beta_0.99999.txt/;
put results;

put 'Orders ', @20, 'Exp_profit ', @40, 'Exp_sales ', @60, 'Exp_lost_sales ',
@80, 'Exp_leftover ', @100, 'Stockout_prob ', @120,'CVaR'//;

put  q.l, @20, exp_profit.l, @40, exp_sales, @60, exp_lost_sales,
@80, exp_leftover, @100, stockout_prob, @120, cvar.l//;
