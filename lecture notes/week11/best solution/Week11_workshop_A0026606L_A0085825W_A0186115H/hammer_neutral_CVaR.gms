...
Scalars mean      mean demand                                  /3192/
        ...
        v         salvage value                                /90/
        beta      prob. of not being in the tail               /0.5/;
...
Display exp_profit.l, q.l, profit.l,sales.l, leftover.l, demand, var.l, cvar.l;
...
Scalars exp_sales expected sales
        ...
        var_result output for var
        cvar_result output for cvar;
...
********************************************************************************
file results /hammer_results_CVaR_Task3.txt/;
put results;
...
* , @120, var_result, @140m cvar_result
