...
Display exp_profit.l, exp_sales, exp_lost_sales, exp_leftover, stockout_prob, cvar.l, var.l;


********************************************************************************
***** Display Results in Text Files ********************************************
********************************************************************************
*file results /hammer_results_CVaR.txt/;
*the name of output
*put results;
...
*put  q.l, @20, exp_profit.l, @60, exp_sales, @60, exp_lost_sales,
*@80, exp_leftover, @100, stockout_prob//;
