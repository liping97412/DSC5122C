...
Scalars mean      mean demand                                  /3192/
        ...
        v         salvage value                                /90/
        beta      prob. of not being in the tail               /0.999/;
...
Variables   q          number of suits ordered from supplier
            ...
            var           value at Risk
            mu           tail profit in worst case
            cvar       conditional value at risk;

Positive Variable q, sales, leftover, z;
...
Equations  sales_demand(s)    sales in scenario s less than demand
           ...
           tails(s)           value of tail in scenario s
           cvar_eq            conditional value at risk;
...
tails(s)..        mu=g= var-profit(s);

cvar_eq..         cvar =e= var-1/((1-beta)*card(s))*sum(s,mu);


Model hammer  / all / ;

Solve hammer using lp maximizing mu;

Display exp_profit.l, q.l, profit.l,sales.l, leftover.l, demand, cvar.l, var.l;
